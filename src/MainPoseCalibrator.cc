...
/****************************************************************************************
 *
 * \file MainPoseCalibrator.cc
 * \brief Main entry point for pose_calibrator
 *
...
{
  ros::init(argc, argv, "pose_calibrator"); 
  ros::NodeHandle nh;
  
  ROS_INFO("  Welcome to pose_calibrator ");
  ROS_INFO("  ------------------------ ");
  ...
  try
  {
    PoseCalibrator calib;
    calib.Run();
  }
  catch(CVD::Exceptions::All e)
  {
    ROS_ERROR("Failed to run pose_calibrator; got exception. ");
