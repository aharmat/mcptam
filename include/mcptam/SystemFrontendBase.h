 ...
 *(mjtribou@uwaterloo.ca)
 *
 * Base class for System and SystemClient, contains functions common to the
 *frontend
 * such as publishing state and pose, and providing services for initializing
 *and
 * resetting the tracker. The tracker object lives here.
 *
 ****************************************************************************************/

#ifndef MCPTAM_SYSTEMFRONTENDBASE_H
#define MCPTAM_SYSTEMFRONTENDBASE_H
...
protected:
  ...
  CVD::ImageRef mirSmallImageSize;  ///< Full size of compound small image that
  ...
  int64_t mnGrabAttempts;
  int64_t mnGrabSuccesses;
  ...
  ros::Publisher mSmallImagePointsPub;  ///< Publishes measurements the can be
  /// displayed in the small tracker image
  ros::Publisher mSystemInfoPub;  ///< Publishes diagnostic messages about
  /// framerate and computation durations
...
#endif  // MCPTAM_SYSTEMFRONTENDBASE_H
